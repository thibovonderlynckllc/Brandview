...
const Footer = () => {
    return (
        <div className="bg-blue">
            <footer className="px-8 sm:px-28 py-10 flex flex-col lg:flex-row justify-between lg:items-center gap-10 lg:gap-5 xl:gap-0 max-w-screen-2xl mx-auto w-full">
                {/* Tagline section */}
